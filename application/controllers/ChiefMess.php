...
class ChiefMess extends CI_Controller
{
    ...
    public function complaint()
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            if ($query) {
                $this->load->view('chiefmess/complaint', $data);
            }
        }
    }
    ...
    public function update_complaint($complaint_id = null)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $this->load->view('chiefmess/update_complaint', $data);
        }
    }
    ...
    public function update_complaint_process()
    {
        ...
        if (!empty($insert)) {
            ...
            redirect('ChiefMess/complaint');
        } else {
            $this->session->set_flashdata('failure', 'Something went wrong, try again.');
            redirect('ChiefMess/update_complaint');
        }
    }
    ...
    public function reservation()
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $this->load->view('chiefmess/reservations', $data);
        }
    }
