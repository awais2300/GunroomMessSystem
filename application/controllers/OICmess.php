...
class OICmess extends CI_Controller
{
    ...
    public function index()
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $this->load->view('OICmess/admin');
        } else {
            $this->load->view('OICmess/login');
        }
    }
    ...
    public function add_users()
    {
        ...
        $this->load->view('OICmess/create_user', $data);
    }
    ...
    public function login_process()
    {
        if ($this->input->post()) {
            ...
            $query = $this->db->where('username', $username)->where('acct_type', 'OICmess')->get('security_info')->row_array();
            $hash = $query['password'];
            ...
            if (!empty($query)) {
                if (password_verify($password, $hash)) {
                    ...
                    $this->session->set_flashdata('failure', 'No such user exist. Kindly create New User using OICmess panel');
                    redirect('OICmess');
                }
                //print_r($query); exit; 
            } else {
    ...
    public function update_complaint_process()
    {
        ...
        if (!empty($insert)) {
            ...
            redirect('OICmess/complaint');
        } else {
            $this->session->set_flashdata('failure', 'Something went wrong, try again.');
            redirect('OICmess/update_complaint');
        }
    }
    public function  update_guest_reservation_process($id = null)
    {
        ...
        if (!empty($insert)) {
            ...
            redirect('OICmess/reservation');
        } else {
            $this->session->set_flashdata('failure', 'Something went wrong, try again.');
            redirect('OICmess/update_guest_reservation');
        }
    }
    ...
    public function  update_requesting_menu_process($id = null)
    {
        ...
        if (!empty($insert)) {
            $this->session->set_flashdata('success', 'Submitted successfully');
            redirect('OICmess/menu_requests');
        } else {
            $this->session->set_flashdata('failure', 'Something went wrong, try again.');
            redirect('OICmess/update_menu_requests');
        }
    }
    ...
    public function update_guest_reservation($id = null)
    {
        ...
        $this->load->view('OICmess/update_guest_reservation', $data);
    }
    ...
    public function update_menu_requests($id = null)
    {
        ...
        $this->load->view('OICmess/update_requesting_menu', $data);
    }

    public function forgot_password()
    {
        $this->load->view('OICmess/forgot_password');
    }
    ...
    public function change_password()
    {
        if ($this->input->post()) {
            ...
            if (!empty($insert)) {
                ...
                $this->session->set_flashdata('failure', 'Something went wrong, try again.');
                redirect('OICmess/forgot_password');
            }
        } else {
            $this->session->set_flashdata('failure', 'Something went wrong, Try again.');
            redirect('OICmess/add_users');
    ...
    public function complaint()
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            // $query = $this->db->set('OICmess_seen', 'yes')->where('OICmess_seen', 'no')->update('complaints');
            // if ($query) {
            $this->load->view('OICmess/select_complaints');
            // }
        }
    }
    ...
    public function show_complaint($type = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            if ($query) {
                $this->load->view('OICmess/complaint', $data);
            }
        }
    }
    public function update_complaint($complaint_id = null)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $this->load->view('OICmess/update_complaint', $data);
        }
    }
    ...
    public function view_activity_log()
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $this->load->view('OICmess/activity_log', $data);
        }
    }
