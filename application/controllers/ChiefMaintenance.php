...
class ChiefMaintenance extends CI_Controller
{
    ...
    public function index()
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $this->load->view('chiefmaintenance/dashboard');
        } else {
    ...
    public function complaint()
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            if ($query) {
                $this->load->view('chiefmaintenance/complaint', $data);
            }
        }
    }
    ...
    public function update_complaint($complaint_id = null)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $this->load->view('chiefmaintenance/update_complaint', $data);
        }
    }
    ...
    public function update_complaint_process()
    {
        ...
        if (!empty($insert)) {
            ...
            redirect('ChiefMaintenance/complaint');
        } else {
            $this->session->set_flashdata('failure', 'Something went wrong, try again.');
            redirect('ChiefMaintenance/update_complaint');
        }
    }
