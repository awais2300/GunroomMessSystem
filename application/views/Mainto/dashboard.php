...
<div class="container">
    ...
    <form class="user" role="form" method="post" id="add_form">
        ...
        <div class="form-group row justify-content-center" style="margin-top:50px;padding:15px">
            ...
            <div class="col-sm-4">
                <button type="button" class="btn btn-primary btn-user btn-block" style="height:55px;  box-shadow: 5px 10px #888888;" id="btn_material" onclick="location.href='<?php echo base_url(); ?>Mainto/complaint'">
