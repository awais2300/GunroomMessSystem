            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <form class="user" role="form" method="post" id="add_form1" action="<?= base_url(); ?>Admin/add_user">
                                ...
                                <div class="form-group row" style="display:none" id="ans_div">
                                    <div class="col-sm-12 mb-1">
                                    <input type="text" class="form-control form-control-user" id="secret_question_ans" name="secret_question" placeholder="Secret Question Answer">
                                    </div>
                                </div>
                        ...
                        <div class="card-body bg-custom3" style="display:none" id="update_form">
                            <form class="user" role="form" method="post" id="add_form" action="<?= base_url(); ?>Admin/change_password">
                              <br>
                                <div class="form-group row">
...
<script>
    ...
    $("#username").blur(function(){
       ...
       // alert(username);
        $.ajax({
                url: '<?= base_url(); ?>Admin/get_secret_question',
                method: 'POST',
                data: {
                    'username': username
                },
...
$("#secret_question_ans").blur(function(){
        ...
        alert(ans);
        $.ajax({
                url: '<?= base_url(); ?>Admin/get_update_password_form',
                method: 'POST',
                data: {
                    'username': username,
                    'ques': ques,
