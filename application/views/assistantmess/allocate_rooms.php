        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body bg-custom3">
                        <form class="user" role="form" enctype="multipart/form-data" method="post" id="save_form" action="<?= base_url(); ?>AssistantMess/room_allocation_process">
...
<script type="text/javascript">
    ...
    //alert(value);
    $.ajax({
                url: '<?= base_url(); ?>AssistantMess/get_floors_of_gunroom',
                method: 'POST',
                data: {
                    'gunroom_id': value
                },
...
$(document).on('change', '#floor', function() {
    ...
    //alert(value);
    $.ajax({
                url: '<?= base_url(); ?>AssistantMess/get_rooms_of_floor',
                method: 'POST',
                data: {
                    'gunroom_id': value,
                    'floor_id':value2
    ...
    $('#room').on('change', function() {
        ...
        if (validate == 0) {
            $.ajax({
                url: '<?= base_url(); ?>AssistantMess/get_rooms_status',
                method: 'POST',
                data: {
                    'gunroom': gunroom,
                    'floor': floor,
