            ...
            <div class="row">
                <div class="col-lg-12">
                                        ...
                                        <tbody id="table_rows_cont">
                                            ...
                                            foreach ($gunrooms_floors as $data) { ?>
                                                <tr>
                                                    ...
                                                    <td type="button" scope="row"><a type="button" class="btn btn-primary btn-user rounded-pill" href="<?= base_url(); ?>AssistantMess/add_new_room/<?= $data['id']; ?>/<?= $data['gunroom_id']; ?>"> Add Rooms</a></td>
                    ...
                    <form class="user" role="form" method="post" id="add_form" action="">
                        <div class="form-group row my-2 justify-content-center">
                            <div class="col-sm-4">
                                <button type="button" class="btn btn-primary btn-user btn-block" onclick="location.href='<?php echo base_url(); ?>AssistantMess/add_new_gunroom'">
