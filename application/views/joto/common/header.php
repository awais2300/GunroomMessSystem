    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center">
                ...
                <div class="sidebar-brand-text mx-3">GUNROOM & MESS SYSTEM</div>
            </a>
            ...
            <?php if ( $this->session->userdata('acct_type') == 'Joto' ) { ?>
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="<?php echo base_url(); ?><?php echo 'Joto'; ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?= base_url(); ?>Joto/complaint" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
                        <i class="fas fa-fw fa-user"></i>
                ...
                <?php $unseen_reservations = $this->db->where('joto_seen', 'no')->from('guest_reservation')->count_all_results(); ?>
                <li class="nav-item">
                    <a class="nav-link collapsed" href="<?php echo base_url(); ?>Joto/reservation" aria-expanded="true">
                ...
                <?php $unseen_menu_requests = $this->db->where('joto_seen', 'no')->from('requesting_menu')->count_all_results(); ?>
                <li class="nav-item">
                    <a class="nav-link collapsed" href="<?php echo base_url(); ?>Joto/menu_requests" aria-expanded="true">
