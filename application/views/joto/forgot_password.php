                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body bg-custom3" id="pre_req">
                            <form class="user" role="form" method="post" id="add_form1" action="<?= base_url(); ?>joto/add_user">
                    ...
                    <div class="card-body bg-custom3" style="display:none" id="update_form">
                        <form class="user" role="form" method="post" id="add_form" action="<?= base_url(); ?>joto/change_password">
                            <br>
                            <div class="form-group row">
...
<script>
    ...
    $("#username").blur(function() {
        ...
        // alert(username);
        $.ajax({
            url: '<?= base_url(); ?>joto/get_secret_question',
            method: 'POST',
            data: {
                'username': username
            },
    ...
    $("#secret_question_ans").blur(function() {
        ...
        // alert(ans);
        $.ajax({
            url: '<?= base_url(); ?>joto/get_update_password_form',
            method: 'POST',
            data: {
                'username': username,
                'ques': ques,
